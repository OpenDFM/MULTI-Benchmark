"""Qwen2.5VL evaluator with HuggingFace Transformers"""
...
class Qwen2_5VLEvaluator:
    def __init__(self, model_dir="Qwen/Qwen2.5-VL-7B-Instruct",  # "Qwen/Qwen-VL-Chat"
                 max_tokens=2000, device_map="auto",use_flash_attention=True):
        ...
        if use_flash_attention:
            self.model = Qwen2_5_VLForConditionalGeneration.from_pretrained(self.model_dir, torch_dtype=torch.bfloat16, attn_implementation="flash_attention_2", device_map="auto")
        else:
            self.model = Qwen2_5_VLForConditionalGeneration.from_pretrained(self.model_dir, torch_dtype="auto", device_map="auto")
